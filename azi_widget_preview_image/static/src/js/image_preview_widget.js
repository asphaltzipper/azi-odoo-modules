...
patch(ImageField.prototype, 'widget_preview_image/static/src/js/image_preview_widget.js', {
    ...
    img_click(ev) {
        ...
        if (clickedImg.src.includes("avatar_128") && (clickedImg.name != 'avatar_128')){
         ...
         else if (clickedImg.src.includes("image_medium_big") && (clickedImg.name != 'image_medium_big')){
            newImg.src = clickedImg.src.replace("image_medium_big", "image_1920");
        }
        else {
